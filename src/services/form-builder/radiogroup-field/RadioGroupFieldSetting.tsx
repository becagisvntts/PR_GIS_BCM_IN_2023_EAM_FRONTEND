...
import RadioGroupFieldOption from './RadioGroupFieldOption'
...
export default class RadioGroupFieldSetting extends FieldSetting {
  options: IOption[]
  value: string
  ...
  override copyWith(json: any) {
    return new RadioGroupFieldSetting(
      json.type ?? this.type,
