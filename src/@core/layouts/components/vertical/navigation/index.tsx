...
const Navigation = (props: Props) => {
  ...
  let lightTheme = createTheme(themeOptions(settings, 'light'))
        ...
        <Box sx={{ position: 'relative', overflow: 'hidden' }}>
          ...
          >
            ...
            {userNavMenuContent ? (
              ...
              <List
                className='nav-items'
                sx={{ pt: 0, '& > :first-of-type': { mt: '40px' } }}
                // subheader={
                //   <ListSubheader
                //     component='div'
                //     id='management-subheader'
                //     sx={{ lineHeight: '32px', background: 'transparent', color: '#fff' }}
                //   >
                //     <Translations text='manage' />
                //   </ListSubheader>
                // }
              >
                <VerticalNavItems
